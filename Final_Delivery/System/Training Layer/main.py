...
sys.path.append(os.path.join(parent_dir, 'Data Processing Layer'))
...
def main():
    ...
    try:
        ...
        if processed_df is not None:
            ...
            processed_df.to_csv(os.path.join(parent_dir, 'OUT/processed_data.csv'), index=False)
        ...
        analyzer.export_analysis_results(os.path.join(parent_dir, 'OUT/feature_analysis_results.json'))
